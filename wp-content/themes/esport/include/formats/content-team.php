							...
							echo '<div class="player-wrapper">';
								...
								echo '<div class="image" style="background-image:url(' . esc_url( $bg_url[0] ) . ');">';
									echo '<div class="content">';
										$team_profession = get_post_meta( get_the_ID(), "team_profession", true );
										if( !empty( $team_profession ) ) {
											echo '<div class="username">' . esc_attr( $team_profession ) . '</div>';
										}
										...
										$team_social_media_twitch = get_post_meta( get_the_ID(), 'team_social_media_twitch', true );
										...
										$social_media_vimeo = get_post_meta( get_the_ID(), 'team_social_media_vimeo', true );
											...
											echo '<ul class="post-share">';
												...
												if( !empty( $team_social_media_twitch ) ) {
													echo '<li><a href="' . esc_url( $team_social_media_twitch ) . '" class="twitch" title="' . esc_html__( 'Twitch', 'esport' ) . '" target="_blank"><i class="fa fa-twitch"></i></a></li>';
												}
